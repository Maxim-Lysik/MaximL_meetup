...
class GetRoomsUseCase @Inject constructor(private val context: Context, private val acivity: AppCompatActivity, private val firebaseRepository: FirebaseRepository) {
